  ...
  async (notification) => {
    try {
      const response = await axios.post(
        `${process.env.EXPO_PUBLIC_SERVER_IP}/api/notification/add`,
  ...
  async (id) => {
    try {
      const response = await axios.get(
        `${process.env.EXPO_PUBLIC_SERVER_IP}/api/notification/get/${id}`
      );
  ...
  async (id) => {
    try {
      const response = await axios.delete(
        `${process.env.EXPO_PUBLIC_SERVER_IP}/api/notification/delete/${id}`
      );
