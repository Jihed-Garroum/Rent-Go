  ...
  async (id) => {
    try {
      const response = await axios.get(
        `${process.env.EXPO_PUBLIC_SERVER_IP}/api/car/carById/${id}`
      );
...
export const getallCarByAgency = createAsyncThunk(
  ...
  async (id) => {
    try {
      const response = await axios.get(
        `${process.env.EXPO_PUBLIC_SERVER_IP}/api/car/allCarByAgency/${id}`
        // ,{ AgencyId: id }
      );
  ...
  async (body) => {
    ...
    try {
      const response = await axios.delete(
        `${process.env.EXPO_PUBLIC_SERVER_IP}/api/car/deletedCar/${id}/${AgencyId}`
      );
...
export const getAllCars = createAsyncThunk("car/getAllCars", async () => {
  try {
    const response = await axios.get(
      `${process.env.EXPO_PUBLIC_SERVER_IP}/api/car/allCars`
    );
  ...
  async (filterCriteria) => {
    try {
      const response = await axios.post(
        `${process.env.EXPO_PUBLIC_SERVER_IP}/api/car/filtredCar`,
        filterCriteria
      );
...
export const createCar = createAsyncThunk("car/createCar", async (params) => {
  ...
  try {
    const response = await axios.post(
      `${process.env.EXPO_PUBLIC_SERVER_IP}/api/car/newCar`,
      params.body
    );
    ...
    await axios.post(
      `${process.env.EXPO_PUBLIC_SERVER_IP}/api/media/add/car/${requestId}`,
      params.media
    );
    return response.data;
  } catch (error) {
...
export const createImgeForCar = createAsyncThunk(
  ...
  async (id) => {
    try {
      const response = await axios.post(
        `${process.env.EXPO_PUBLIC_SERVER_IP}/api/car/imageCar`
      );
...
export const getAllBoolMarks = createAsyncThunk(
  ...
  async (id) => {
    try {
      const response = await axios.get(
        `${process.env.EXPO_PUBLIC_SERVER_IP}/api/bookmarks/getAll/${id}`
      );
...
export const CreateBookMark = createAsyncThunk(
  ...
  async (body) => {
    try {
      const response = await axios.post(
        `${process.env.EXPO_PUBLIC_SERVER_IP}/api/bookmarks/add`,
        body
      );
...
export const removedBookMark = createAsyncThunk(
  ...
  async (id) => {
    try {
      const response = await axios.delete(
        `${process.env.EXPO_PUBLIC_SERVER_IP}/api/bookmarks/delete/${id}`
      );
...
export const updateCar = createAsyncThunk("car/updateCar", async (body) => {
  try {
    ...
    const response = await axios.put(
      `${process.env.EXPO_PUBLIC_SERVER_IP}/api/car/cars/${id}`,
      body
    );
